...
const Section3 = () => {
  ...
  return (
    <div className="flex flex-col  relative ">
      <motion.div className="heading sm:sticky w-full  sm:top-20 p-4 z-40 bg-white">
        <Heading
          heading="Loans"
      ...
      <div className=" flex flex-col gap-12 mt-6  px-4 sm:px-12 lg:px-12 2xl:px-0  " ref={ref}>
