  ...
  return (
    <div className="flex flex-col  relative ">
      ...
      <div className=" flex flex-col gap-24  px-4 sm:px-12 lg:px-12 2xl:px-0  " ref={ref}>
        <div className="group1 flex flex-col sm:gap-8 sm:sticky  sm:top-72  z-10 sm:my-6 border border-gray-300 shadow-lg p-8 py-12 rounded-lg">
          <motion.div
        ...
        <div className="group2 flex flex-col gap-8  sm:sticky top-72 bg-white border border-gray-300 z-20 sm:my-6 shadow-lg p-8 py-12 rounded-lg">
          <motion.div
        ...
        <div className="group3 flex flex-col gap-8  sticky top-72 border border-gray-300 bg-white z-30 sm:my-6 shadow-lg p-8 py-12 rounded-lg ">
          <motion.div
            className="heading flex gap-2 items-center "
            initial={{ y: 75, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
