...
const Card = ({  subtitle, Icon, href }) => {
  return (
    ...
    >
      ...
      <Icon className="mb-2 text-lg sm:text-xl md:text-2xl lg:text-3xl text-mainBlue  transition-colors relative z-10 duration-300" />

      <p className="opacity-90  font-semibold  relative z-10 duration-300 lg:leading-7 leading-6 text-xs lg:text-sm xl:leading-8  2xl:text-xl 2xl:leading-8">
        {subtitle}
      </p>
    </motion.div>
  );
