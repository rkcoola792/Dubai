...
const ShimmerBorderCard = () => {
  return (
    <div className="group relative mx-auto w-full max-w-sm overflow-hidden rounded-lg  p-0.5 transition-all duration-500 hover:scale-[1.01] hover:bg-mainBlue-800/50">
      <div className="relative z-10 flex flex-col  p-8  overflow-hidden rounded-lg bg-[#EBF3F9]  transition-colors duration-500  ">
    
        <h4 className="relative z-10 mb-4 w-full text-3xl font-semibold  ">
          Introduction
        </h4>
        ...
        <h1 className="uppercase  border-mainBlue border-2 p-4 rounded-lg w-[70%] text-mainBlue font-semibold cursor-pointer hover:bg-mainBlue transition duration-200 ease-linear hover:ease-linear z-50 mt-6 hover:text-white ">
          {" "}
          Schedule a meet{" "}
          <span>
            <ArrowOutwardIcon />
