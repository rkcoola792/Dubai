...
const Card = ({ subtitle, Icon, href }) => {
  return (
    <motion.div
      className="  rounded border-[1px] border-slate-300 relative overflow-hidden group bg-subtleBlue cursor-pointer px-3 py-3 h-36 w-36"
      initial={{ y: 0 }}
    ...
    >
      ...
      <p className="text-slate-400 group-hover:text-violet-200 relative z-10 duration-300 text-xs mt-2">
        {subtitle}
      </p>
    </motion.div>
  );
