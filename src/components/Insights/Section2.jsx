            ...
            <div className="bottom flex gap-8  mt-6 text-gray-600">
              <div className="left  w-[45%] flex flex-col gap-4">
                ...
                <h1 className="leading-[20px]">
                  ...
                  contribution from UK taxpayers. Axiom told the BBC that
                  conversations with corporations and institutions interested in
                  providing finance were already under way.
                </h1>
              </div>
              <div className="right w-[45%] flex flex-col gap-4">
                ...
                <h1 className="leading-[20px]">
                  ...
                  concept yet for how it would be seleted there a concept yet.
                </h1>
              </div>
            </div>
          </div>
